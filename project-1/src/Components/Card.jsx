...
const Card = ({data}) => {
    ...
    return (
        <>
            <div className="card w-full h-auto max-w-md bg-green-950 rounded-[10%] p-2 text-white shadow-xl">
                    <div className="bg-green-800 pb-3 text-center rounded-b-[12%] rounded-[10%] overflow-hidden">

                        <img src={data.photo} alt="image" className="w-96 object-cover rounded-[10%]" />
                ...
                <div className="content px-6 py-2 flex justify-between items-center ">
                    ...
                    <div className="price border-l-2 border-green-400/20 pl-4">
                        <h2 className="text-4xl items-center font-[14px]">{data.price}</h2>
                        <p className="flex text-base">Order Now 
                            <span><MoveUpRight className="w-3.5 h-3.5 stroke-3"/></span>
                        </p>
                    </div>
                </div>
            </div>
